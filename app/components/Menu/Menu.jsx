  ...
  return (
    <>
      <Drawer variant="permanent" open={open} >
        ...
        {open ?
          <Image src={'/nexum/Logo_Lab.jpg'} alt='Logo_Lab' style={{ alignSelf:'center', margin:'10px' }} height={78} width={220} /> :
          <Image src={'/nexum/logo_Lab_sm.png'} alt='Logo_Lab_sm' style={{ alignSelf:'center', margin:'10px' }} height={40} width={40} /> 
        }
        <Divider />
